...
export default class Home extends Component {
 ...
 pos = [];
  ...
  // _fetchMoreData(props){
  //  console.log("来了吗");
  //     let date = new Date(+this.now-24*60*60*1000 * this.count);
  //     let dateText = DateUtil.getDateText(date);
  //     props.fetchArticleBefore(dateText,DateUtil.getBeforeText(date));
